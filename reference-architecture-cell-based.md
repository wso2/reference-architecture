...
+ Asanka Abeysinghe | Deputy CTO & VP of Architecture - CTO Office | WSO2, Inc | <asankaa@wso2.com>
...
[Cellery](https://cellery.io/) is a code-first approach (infrastructure as a code) to building, integrating, running and managing composite applications on Kubernetes. Build, push/pull, test, deploy, update, scale and observe cells. Create secure APIs by default. Use your existing container images, written in any language.
